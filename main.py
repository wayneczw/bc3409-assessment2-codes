...
cont_features = [
    ...
    'Low', 'Volume',
    'Adj Close', 'Crude Oil',
    'Brent Crude', 'Unleaded Gasoline',
    'Heating Oil', 'Gas Oil',
    'Natural Gas',
    # 'RXI$US_N.B.EU', 'RXI$US_N.B.UK',
    # 'RXI_N.B.BZ', 'RXI_N.B.CH',
    # 'RXI_N.B.DN', 'RXI_N.B.IN',
    # 'RXI_N.B.JA', 'RXI_N.B.KO',
    # 'RXI_N.B.MA', 'RXI_N.B.MX',
    # 'RXI_N.B.NO', 'RXI_N.B.SD',
    # 'RXI_N.B.SF', 'RXI_N.B.SI',
    # 'RXI_N.B.SZ', 'RXI_N.B.TA',
    # 'RXI_N.B.TH', 'RXI_N.B.VE',
    # 'JRXWTFB_N.B', 'JRXWTFN_N.B',
    # 'JRXWTFO_N.B', 'RXI$US_N.B.AL',
    # 'RXI$US_N.B.NZ', 'RXI_N.B.CA',
    # 'RXI_N.B.HK', 'RXI_N.B.SL',
